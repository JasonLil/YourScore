 ...
 *       &lt;attribute name="segnoAtt" type="{http://www.w3.org/2001/XMLSchema}token" />
 *       &lt;attribute name="dalsegno" type="{http://www.w3.org/2001/XMLSchema}token" />
 *       &lt;attribute name="codaAttribute" type="{http://www.w3.org/2001/XMLSchema}token" />
...
public class Sound {
    ...
    @XmlAttribute(name = "segnoAtt")
    @XmlJavaTypeAdapter(CollapsedStringAdapter.class)
    @XmlSchemaType(name = "token")
    protected String segnoAtt;
    @XmlAttribute(name = "dalsegno")
    @XmlJavaTypeAdapter(CollapsedStringAdapter.class)
    @XmlSchemaType(name = "token")
    protected String dalsegno;
    @XmlAttribute(name = "codaAttribute")
    @XmlJavaTypeAdapter(CollapsedStringAdapter.class)
    @XmlSchemaType(name = "token")
    ...
    /**
     * Gets the value of the segnoAtt property.
     * 
     * @return
     *     possible object is
     *     {@link String }
     *     
     */
    public String getSegnoAtt() {
        return segnoAtt;
    }

    /**
     * Sets the value of the segnoAtt property.
     * 
     * @param value
     *     allowed object is
     *     {@link String }
     *     
     */
    public void setSegnoAtt(String value) {
        this.segnoAtt = value;
    }
