 ...
 *         &lt;element name="segnoE" type="{}empty-print-style-align" maxOccurs="unbounded"/>
 *         &lt;element name="words" type="{}formatted-text" maxOccurs="unbounded"/>
 *         &lt;element name="codaElement" type="{}empty-print-style-align" maxOccurs="unbounded"/>
...
public class DirectionType {
    ...
    protected List<EmptyPrintStyleAlign> segnoE;
    protected List<FormattedText> words;
    protected List<EmptyPrintStyleAlign> codaElement;
    ...
    /**
     * Gets the value of the segnoE property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the segnoE property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getSegnoE().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<EmptyPrintStyleAlign> getSegnoE() {
        if (segnoE == null) {
            segnoE = new ArrayList<EmptyPrintStyleAlign>();
        }
        return this.segnoE;
    }
    ...
    /**
     * Gets the value of the codaElement property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the codaElement property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getCodaElement().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<EmptyPrintStyleAlign> getCodaElement() {
        if (codaElement == null) {
            codaElement = new ArrayList<EmptyPrintStyleAlign>();
        }
        return this.codaElement;
    }
