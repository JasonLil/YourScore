 ...
 *               &lt;element name="link1" type="{}link" maxOccurs="unbounded" minOccurs="0"/>
 *               &lt;element name="bookmarkElem" type="{}bookmark" maxOccurs="unbounded" minOccurs="0"/>
 *               &lt;element name="credit-words" type="{}formatted-text"/>
 *             &lt;/sequence>
 *           &lt;/sequence>
 *         &lt;/choice>
...
@XmlType(name = "credit", propOrder = {
    ...
    "creditImage",
    "creditWords",
    "link1AndBookmarkElemAndCreditWords"
})
public class Credit {

    @XmlElement(name = "credit-type")
    protected List<String> creditType;
    ...
    @XmlElements({
        @XmlElement(name = "link1", type = Link.class),
        @XmlElement(name = "bookmarkElem", type = Bookmark.class),
        @XmlElement(name = "credit-words", type = FormattedText.class)
    })
    protected List<Object> link1AndBookmarkElemAndCreditWords;
    ...
    /**
     * Gets the value of the link1AndBookmarkElemAndCreditWords property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the link1AndBookmarkElemAndCreditWords property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getLink1AndBookmarkElemAndCreditWords().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<Object> getLink1AndBookmarkElemAndCreditWords() {
        if (link1AndBookmarkElemAndCreditWords == null) {
            link1AndBookmarkElemAndCreditWords = new ArrayList<Object>();
        }
        return this.link1AndBookmarkElemAndCreditWords;
    }
